...
class BoardBuilder {
    ...
    buildBoard() {
        ...
        // Actualizar contador de voxels en la UI solo si el elemento existe
        const voxelCountElement = document.getElementById('voxelCount');
        if (voxelCountElement) {
            voxelCountElement.textContent = this.voxelCount;
        } else {
            console.warn('Elemento voxelCount no encontrado en el DOM');
        }
